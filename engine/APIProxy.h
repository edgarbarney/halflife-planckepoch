...
typedef int (*HUD_CL_ISTHIRDPERSON_FUNC) ( );
...
typedef HL_HSPRITE						(*pfnEngSrc_pfnSPR_Load_t )			( const char *szPicName );
typedef int							(*pfnEngSrc_pfnSPR_Frames_t )			( HL_HSPRITE hPic );
typedef int							(*pfnEngSrc_pfnSPR_Height_t )			( HL_HSPRITE hPic, int frame );
typedef int							(*pfnEngSrc_pfnSPR_Width_t )			( HL_HSPRITE hPic, int frame );
typedef void						(*pfnEngSrc_pfnSPR_Set_t )				( HL_HSPRITE hPic, int r, int g, int b );
...
typedef void						(*pfnEngSrc_pfnSetCrosshair_t )		( HL_HSPRITE hspr, wrect_t rc, int r, int g, int b );
...
typedef int							(*pfnEngSrc_pfnAddCommand_t )			( const char *cmd_name, void (*pfnEngSrc_function)() );
...
typedef int							(*pfnEngSrc_IsNoClipping_t )			( );
...
typedef const struct model_s *		(*pfnEngSrc_GetSpritePointer_t )		( HL_HSPRITE hSprite );
...
typedef int							(*pfnEngSrc_IsSpectateOnly_t ) ( );
...
typedef int						(*pfnEngSrc_pfnGetAppID_t)			( );
...
typedef void	(*pfnEngDst_pfnSPR_Frames_t )			( HL_HSPRITE * );
typedef void	(*pfnEngDst_pfnSPR_Height_t )			( HL_HSPRITE *, int * );
typedef void	(*pfnEngDst_pfnSPR_Width_t )			( HL_HSPRITE *, int * );
typedef void	(*pfnEngDst_pfnSPR_Set_t )				( HL_HSPRITE *, int *, int *, int * );
...
typedef void	(*pfnEngDst_pfnSetCrosshair_t )			( HL_HSPRITE *, struct rect_s *, int *, int *, int * );
...
typedef void	(*pfnEngDst_GetSpritePointer_t )		( HL_HSPRITE * );
