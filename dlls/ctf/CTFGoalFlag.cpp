	...
	if (pPlayer && (m_iGoalNum == 1 || m_iGoalNum == 2))
	{
		for (int i = 1; i <= gpGlobals->maxClients; ++i)
		{
			...
			if (player->m_iTeamNum == pPlayer->m_iTeamNum)
			{
				...
				{
					if (pPlayer == player)
						ClientPrint(player->pev, HUD_PRINTCENTER, "#CTFCaptureFlagP", nullptr, nullptr, nullptr, nullptr);
					else
						ClientPrint(player->pev, HUD_PRINTCENTER, "#CTFCaptureFlagT", nullptr, nullptr, nullptr, nullptr);
				}
