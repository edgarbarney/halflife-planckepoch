...
void COFFuncTank :: KeyValue( KeyValueData *pkvd )
{
...
void COFFuncTankLaser::KeyValue( KeyValueData *pkvd )
{
...
void COFFuncTankMortar::KeyValue( KeyValueData *pkvd )
{
