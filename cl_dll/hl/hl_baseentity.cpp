...
//RENDERERS START
char *CBaseEntity :: DamageDecal( int bitsDamageType ) { return nullptr; }
//RENDERERS END
...
CGrenade *CGrenade::ShootStun( entvars_t* pevOwner, Vector vecStart, Vector vecVelocity, float time ) { return nullptr; };
...
//RENDERERS START
char *DamageDecal( CBaseEntity *pEntity, int bitsDamageType, Vector vecSrc, Vector vecEnd ) { return nullptr; }
...
float CBasePlayerWeapon::GetNextAttackDelayGlobal(float flTime) { return flTime; }
