...
TeamFortressViewport::TeamFortressViewport(int x,int y,int wide,int tall) : Panel(x,y,wide,tall), m_SchemeManager(wide,tall)
{
	...
	m_pCommandMenus[m_PlayerMenu] = new CCommandMenu(nullptr, 1, 
...
int TeamFortressViewport::MsgFunc_SetMenuTeam( const char *pszName, int iSize, void *pbuf )
{
	BEGIN_READ( pbuf, iSize );
...
int TeamFortressViewport::MsgFunc_StatsInfo(const char* pszName, int iSize, void* pbuf)
{
